...
export const ImagingTab: React.FC<ImagingTabProps> = ({
  ...
  const handleRequest = useCallback(async (item: ImagingRow) => {
  ...
  const handleViewImage = useCallback(async (item: ImagingRow) => {
  ...
  const renderImageButton = useCallback((item: ImagingRow) => {
