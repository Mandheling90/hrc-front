...
const renderImageButton = (item: EndoscopyRow) => {
...
const getEndoscopyColumns = (
  onViewResultClick: (item: EndoscopyRow) => void
): TableColumn<EndoscopyRow>[] => [
...
export const EndoscopyTab: React.FC<EndoscopyTabProps> = ({
  ...
  return (
    <>
      <Table
        columns={getEndoscopyColumns(handleViewResultClick)}
        data={pagedRows}
        getRowKey={item => item.id}
        renderTabletCard={getEndoscopyTabletCard(handleViewResultClick)}
        renderMobileCard={getEndoscopyMobileCard(handleViewResultClick)}
      />
